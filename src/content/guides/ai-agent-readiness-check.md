...
ctaUrl: "https://vihrenlabs.gumroad.com/l/rmkje"
ctaLabel: "Get the free assessment (PDF)"
ctaSub: "Run it on your own org: the free AI-Ready Operations Assessment — the five-layer maturity model plus this readiness check as a PDF. (When you're ready, Assessment Pro adds 18 checks across the five dimensions, field-level scoring, and a GO / FIX-FIRST / NOT-READY verdict with a fix-first plan and a worked example.)"
---
