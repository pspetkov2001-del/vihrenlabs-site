...
ctaLabel: "Get the Digital Transformation Operating Model & Roadmap Toolkit — $149"
ctaUrl: "/products/digital-transformation-operating-model-and-roadmap-toolkit"
ctaSub: "The done-for-you version: a 10-tab Excel workbook — current-state assessment, a capability-maturity radar, a multi-wave roadmap, a target operating model, governance and a RAID log, and a value tracker — plus a 15-page operating handbook that carries one worked example through all six moves."
featured: false
---
