...
export const products: Product[] = [
  ...
  },
  {
    ...
    sub: 'The complete AI governance system, bundled: the AI Center of Excellence Handbook (the frame) + the Use-Case Selection Scorecard, AI-Ready Operations Assessment Pro, AI Adoption & AI Agents Playbook and AI Vendor Evaluation & TCO (the tools at each gate). Five products, one operator system.',
    price: '$349', team: '$649',
